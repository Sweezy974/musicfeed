<?php
// get track infos
$songUrl="https://musicdemons.com/api/v1/song/2957";
$songLyricsUrl="https://musicdemons.com/api/v1/song/2957/lyrics";
...
<body>
  ...
  <div id="head-jumbotron">
    <h1 id="single-name">Thank u, next <br><i id="artist-name">By Ariana Grande </i></h1>
    <br>
    <div  id="single-cover">
    ...
    <div id="single-description">
      <div class="description-name">
        <p><i>Produit par  Social House & TBHits </i></p>
      </div>
